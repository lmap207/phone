@extends('layouts.admin') @section('title') 手机添加 @endsection @section('title','手机添加') @section('content')
<hr>
    ...
    <div class="tpl-block">
        <div class="am-g">
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" method="post" action="/phone" enctype="multipart/form-data">
                    
                    <div class="am-form-group">
                        <label for="user-name" class="am-u-sm-3 am-form-label">手机名称 <span class="tpl-form-line-small-title"></span></label>
                        <div class="am-u-sm-9">
                            <input type="text" name="pname" class="tpl-form-input" id="user-name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select data-am-selected="{searchBox: 1}" name="xinghao_id" style="display: none;">
                                ...
                                <option value="{{$v['id']}}">{{$v['xname']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>

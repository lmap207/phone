...
<head>
    ...
    <title>魅族商城-提供魅族 PRO 5、魅族MX系列、魅蓝note系列、魅蓝metal系列产品的预约和购买</title>
    ...
    <meta name="description" content="魅族商城是魅族面向全国服务的官方电子商务平台,提供魅族 PRO 5、魅族MX系列、魅蓝note系列和魅蓝metal系列等产品的预约和购买.官方正品，全国联保。">
...
<![endif]-->
    <link rel="stylesheet" href="/qiantai/css/pkg-home.css">
    <style type="text/css">
    #saoma {
...
<body>
        ...
        <div class="mzcontainer">
            ...
            <span id="MzUserName" class="site-member-name">MEIZU</span>的商城
                        ...
                        <div class="site-member-items">
                            ...
                            <a class="site-member-link site-logout" href="http://store.meizu.com/accounts/logout.htm?useruri=http://store.meizu.com" data-href="http://store.meizu.com/accounts/logout.htm?useruri=">退出</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <!-- 内容start -->
    <div id="saoma">扫码付款</div>
    <div class="fukuan"><img src="/qiantai/images/weixin.png"></div>
    <!-- 内容end -->
    ...
    <div class="site-footer">
        <div class="mzcontainer">
          ...
          <img src="./img/20x21xiaoshi.png" width="20" height="21">
          24小时在线客服
        </a>
                </div>
            </div>
    ...
    <script type="text/javascript" src="/qiantai/js/pkg-home.js"></script>
    <script charset="utf-8">
    var $ = require("common:lib/jquery/jquery-1.11.3");
    $(function() {
        require("home:widgets/settlement-ad/settlement-ad"), require("home:widgets/home-slider/home-slider"), require("home:widgets/home-recommend/home-recommend"), require("home:widgets/home-category/home-category"), require("home:widgets/home-gotop/home-gotop"), require("home:js/jquery.lazyload/jquery.lazyload"), $("img.home-img-lazy").lazyload({});
        var e = document.createElement("img");
        e.src = "http://log2.air.yoyi.com.cn/air/t?s=2503"
    });
    </script>
    <script>
    var __mzt = __mzt || [];

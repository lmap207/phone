<div class="site-topbar clearfix">
        <div class="mzcontainer">
            ...
            <img src="{{$v['logo']}}" alt="" style="width:60px;height:60px;border-radius:360px;margin-right:80px">
            @endforeach
                ...
                <ul class="topbar-info">
                    ...
                    <li class="topbar-info-member" style="">
                        ...
                        <div class="site-member-items">
                            ...
                            <a class="site-member-link site-logout" href="http://store.meizu.com/accounts/logout.htm?useruri=http://store.meizu.com/item/meilan2.html" data-href="http://store.meizu.com/accounts/logout.htm?useruri=">退出</a>
                        </div>
                    </li>
                </ul>
            </div>
